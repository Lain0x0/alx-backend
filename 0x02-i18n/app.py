...
def get_timezone() -> str:
    """the appropriate timezone for the current request."""
    try:
...
def get_user() -> dict:
    """the user based on the 'login_as' query parameter."""
...
def before_request() -> None:
    """the current user before processing the request."""
    g.user = get_user()


@babel.localeselector
def get_locale() -> str:
    """best language for the current user or request."""
...
@app.route("/")
def index() -> str:
    """Render the current time in the user's timezone."""
